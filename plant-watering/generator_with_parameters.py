...
from base import Generator, AbstractProblemPrinter
...
class ProblemPrinter(AbstractProblemPrinter):
    ...
    def __init__(self, problem,language = 'mt'):
...
def Main():
    ...
    for size in range(args.min, args.max + 1):
        for num_plants in range(args.min_num_plants, args.max_num_plants + 1):
            ...
            for run in range(1, args.runs+1):
                ...
                generator(MetricPDDLPrinter(problem, args.constrained))  # The PDDL2.1 + state constraints versions
